...
import ImageUploadNode from './nodes/ImageUploadNode.jsx';
import TextDisplayNode from './nodes/TextDisplayNode.jsx';
import ToggleNode from './nodes/ToggleNode.jsx';
import NumberInputNode from './nodes/NumberInputNode.jsx';
import SelectNode from './nodes/SelectNode.jsx';
...
export const PipelineUI = () => {
  ...
  const onDrop = useCallback(
    (event) => {
      ...
      if (!data) {
        console.warn('No data found for the dropped element');
        return;
      }
